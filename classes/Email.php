...
class Email
{
    ...
    public function enviarInstrucciones()
    {
        ...
        $contenido .= "<p>Presiona aquí: 
         <a href='http://thedoggyfriends.com/restablecer?token=" . $this->token . "'>Reestablecer Contraseña</a></p> ";
        $contenido .= "<p>Si tu no solicitaste el reestablecimiento de tu contraseña, puedes ignorar este mensaje</p>";
        $contenido .= "</html>";
